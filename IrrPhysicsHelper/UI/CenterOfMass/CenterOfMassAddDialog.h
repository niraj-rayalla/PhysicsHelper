...
///-----------------------------------------------------------------
///
/// @file      CenterOfMassAddDialog.h
/// @author    niraj
/// Created:   7/7/2012 12:31:35 PM
/// @section   DESCRIPTION
///            CenterOfMassAddDialog class declaration
///
///------------------------------------------------------------------
...
////Dialog Style Start
#undef CenterOfMassAddDialog_STYLE
#define CenterOfMassAddDialog_STYLE wxCAPTION | wxSYSTEM_MENU | wxDIALOG_NO_PARENT | wxMINIMIZE_BOX | wxCLOSE_BOX
////Dialog Style End

enum CenterOfMassReferenceObjectType
{
    CenterOfMassReferenceObjectType_Absolute,
    CenterOfMassReferenceObjectType_Relative
};

class CenterOfMassAddDialog : public wxDialog
{
	private:
		DECLARE_EVENT_TABLE();
		
	public:
		CenterOfMassAddDialog(wxWindow *parent, wxArrayString (*getObjectNames)(void), wxWindowID id = 1, const wxString &title = wxT("Add Object"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = CenterOfMassAddDialog_STYLE);
		virtual ~CenterOfMassAddDialog();
		...
		bool useCustomName;
		wxString customName;
		CenterOfMassReferenceObjectType refObjType;
		bool isSingleObject;
