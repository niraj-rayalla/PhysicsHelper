...
#ifndef WX_IRR_COULOMB_PANEL
#define WX_IRR_COULOMB_PANEL
...
class CoulombPanel : public TimedSimulationPanel
{
	private:
	...
	public:
		CoulombPanel(wxWindow *parent, void (*addObjectSingle)(wxString _name, bool enabled, float mass, float charge, float radius, float posX, float posY, float posZ, float velX, float velY, float velZ, bool isRelative, int relativeIndex),
		...
		void (*AddObjectSingle)(wxString _name, bool enabled, float mass, float charge, float radius, float posX, float posY, float posZ, float velX, float velY, float velZ, bool isRelative, int relativeIndex);
		void (*AddObjectMultiple)(wxString _name, bool enabled, std::string mass, std::string charge, std::string radius,
			std::string posX, float posXBegin, float posXEnd, float posXRes,
			std::string posY, float posYBegin, float posYEnd, float posYRes,
			std::string posZ, float posZBegin, float posZEnd, float posZRes,
