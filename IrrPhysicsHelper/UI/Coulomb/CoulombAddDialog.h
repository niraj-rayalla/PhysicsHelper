...
///-----------------------------------------------------------------
///
/// @file      CoulombAddDialog.h
/// @author    niraj
/// Created:   7/7/2012 12:31:35 PM
/// @section   DESCRIPTION
///            CoulombAddDialog class declaration
///
///------------------------------------------------------------------

#ifndef WX_IRR_COULOMB_ADD_DIALOG
#define WX_IRR_COULOMB_ADD_DIALOG
...
////Dialog Style Start
#undef CoulombAddDialog_STYLE
#define CoulombAddDialog_STYLE wxCAPTION | wxSYSTEM_MENU | wxDIALOG_NO_PARENT | wxMINIMIZE_BOX | wxCLOSE_BOX
////Dialog Style End

enum CoulombReferenceObjectType
{
    CoulombReferenceObjectType_Absolute,
    CoulombReferenceObjectType_Relative
};

class CoulombAddDialog : public wxDialog
{
	private:
		DECLARE_EVENT_TABLE();
		
	public:
		CoulombAddDialog(wxWindow *parent, wxArrayString (*getObjectNames)(void), wxWindowID id = 1, const wxString &title = wxT("CoulombAddDialog"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = CoulombAddDialog_STYLE);
		virtual ~CoulombAddDialog();
		...
		bool useCustomName;
		wxString customName;
		CoulombReferenceObjectType refObjType;
		bool isSingleObject;
	...
	private:
		...
		wxTextCtrl *SingleChargeTextbox;
		wxStaticText *SingleChargeLabel;
		wxTextCtrl *MultipleChargeTextbox;
		wxStaticText *MultipleChargeLabel;
	...
	private:
		...
		enum
		{
			...
			ID_SINGLECHARGETEXTBOX = 1458,
			ID_SINGLECHARGELABEL = 1457,
			ID_MULTIPLECHARGETEXTBOX = 1455,
			ID_MULTIPLECHARGELABEL = 1454,
